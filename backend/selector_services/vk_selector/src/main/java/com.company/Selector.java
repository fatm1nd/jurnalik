...
public class Selector {
    ...
    public static void selectOne(int user_id) {
        try {
    ...
    public void addAllInforamtionToDB(HashMap<String, String> allGroups, List<UserInfo> allVkUsers, Map<String, List<RawPost>> groupIdToEntityMap, DBController dbController) throws IOException {
